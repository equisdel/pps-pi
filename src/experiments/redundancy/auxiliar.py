from algorithm.fitness import ned,sm,icp,ifn
import ast
from collections import defaultdict
from algorithm.representations import individual_to_microservices
from algorithm.config_instance import CLASS_MAPPING, graph
...
if __name__=="__main__":
    ...
    with open("data/dup_old_Y.csv", "rb") as f:
        old_Y = pd.read_csv(f)

    with open("data/dup_new_Y.csv", "rb") as f:
        new_Y = pd.read_csv(f)
