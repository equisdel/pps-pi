...
import numpy as np
import ast
from redundancy.paths import PF_INPUT_PATH, REDUNDANCY_OUTPUT_PATH, HASH_PATH, PF_OUTPUT_PATH
...
def mark_non_dominated(path=HASH_PATH):
    # mark non dominated
    # save them to ideal_pf (union of all fronts)
    pass

if __name__=="__main__":
    
    pareto_fronts = process_output()
    mark_non_dominated(HASH_PATH)
    #a(pareto_fronts)
